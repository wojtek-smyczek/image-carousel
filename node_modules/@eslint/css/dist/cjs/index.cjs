...
var rules = {
    "no-duplicate-imports": rule0,
    "no-empty-blocks": rule1,
    "no-important": rule2,
    "no-invalid-at-rule-placement": rule3,
    "no-invalid-at-rules": rule4,
    "no-invalid-named-grid-areas": rule5,
    "no-invalid-properties": rule6,
    "prefer-logical-properties": rule7,
    "relative-font-units": rule8,
    "use-baseline": rule9,
    "use-layers": rule10,
};
